...
export const getSupportReplyEmailHtml = (originalMessage: string, replyText: string): string => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <tr>
      <td align="center">
        <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(216,64,91,0.08);">
          <tr>
            <td style="background:linear-gradient(135deg,#FF8989,#D8405B);padding:32px 40px;text-align:center;">
              <h1 style="margin:0;color:#ffffff;font-size:28px;font-weight:700;letter-spacing:-0.5px;">🌙 Lunara Support</h1>
              <p style="margin:8px 0 0;color:rgba(255,255,255,0.9);font-size:14px;">We're here to help</p>
            </td>
          </tr>
          <tr>
            <td style="padding:40px;">
              <h2 style="margin:0 0 16px;color:#3E2723;font-size:20px;font-weight:600;">Response to Your Support Ticket ✉️</h2>
              
              <div style="background:#FFF9FA;border-left:4px solid #D8405B;padding:16px;margin-bottom:24px;border-radius:0 8px 8px 0;">
                <p style="margin:0 0 8px;color:#8D6E63;font-size:12px;font-weight:bold;text-transform:uppercase;">Your Question:</p>
                <p style="margin:0;color:#3E2723;font-size:14px;line-height:1.5;font-style:italic;">"${originalMessage}"</p>
              </div>

              <p style="margin:0 0 8px;color:#8D6E63;font-size:12px;font-weight:bold;text-transform:uppercase;">Our Reply:</p>
              <p style="margin:0 0 32px;color:#3E2723;font-size:15px;line-height:1.6;white-space:pre-wrap;">${replyText}</p>
              
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="lunara://" style="display:inline-block;background:linear-gradient(135deg,#FF8989,#D8405B);color:#ffffff;text-decoration:none;padding:14px 36px;border-radius:12px;font-size:16px;font-weight:600;letter-spacing:0.3px;">Open Lunara</a>
                  </td>
                </tr>
              </table>
            </td>
